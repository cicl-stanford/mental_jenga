...
var Config = function (condition, counterbalance) {
    ...
    // this.condition = 0; //prediction condition 
    // this.condition = 1; //responsibility condition 
    ...
    this.parse_config = function (data) {
        ...
        // this.trials = data["stim"]; //shuffles the array 
        // this.trials = data["stim"]; 
        // this.prompt = data["prompt"] ;
        this.questions = data["questions"] ;
        // this.outcome_text = data["outcome_text"] ;
    };
